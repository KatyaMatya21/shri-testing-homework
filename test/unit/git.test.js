...
describe('git.js', function() {
  ...
  describe('parseHistoryItem', function () {
    ...
    it('преобразует данные в объект', function () {
  ...
  describe('gitHistory', function () {
    ...
    it('получение постраничного списка коммитов', function () {
  ...
  describe('gitFileTree', function () {
    ...
    it('получение дерева файлов', function () {
  ...
  describe('gitFileContent', () => {
    ...
    it('получение содержимого файла', function () {
      const result = gitModule.gitFileContent('hash', mockExecuteGit);
      return expect(result).to.eventually.eql(fakeResult);
    });
  });
